question_data = [
    ...
    {"question": "Google was originally called 'Backup'.", "correct_answer": "True"},
    {
...
question_50_data = [
    {
        ...
        "type": "boolean",
        "difficulty": "medium",
        "question": "AMC The Walking Dead, Rick, Carl, Daryl, Morgan, Carol and Maggie were introduced to us in Season 1.",
        "correct_answer": "False",
    ...
    },
    {
        ...
        "type": "boolean",
        "difficulty": "hard",
        "question": "The song Scatman World was released after Scatman (Ski-Ba-Bop-Ba-Dop-Bop).",
        "correct_answer": "True",
        "incorrect_answers": ["False"],
    },
    {
